...
export default function InputBox ({ inputText, isTestInProgress, handleKeypress, clearInput }: InputBoxProps) {
  return (
    <section className="input-section" title="input-section">
      <form className="input-box">
        <div className="input-box-header">
          ...
          {isTestInProgress && <button id="reset" onClick={clearInput}>Reset</button>}
        </div>
